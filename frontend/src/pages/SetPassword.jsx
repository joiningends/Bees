  ...
  const handleSetPassword = async () => {
    ...
    try {
      const response = await fetch(
        "https://crm.bees.in/api/v1/employee/update/password",
        {
          method: "PUT",
          headers: {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-8 bg-off-white shadow-lg">
        ...
        <form className="w-full max-w-xs" onKeyDown={handleKeyDown}>
          ...
          <button
            ...
            className="bg-pink-600 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded w-full transition duration-300"
